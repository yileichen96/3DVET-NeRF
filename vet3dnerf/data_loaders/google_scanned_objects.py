...
sys.path.append("../")
from .data_utils import rectify_inplane_rotation, get_nearest_pose_ids, parse_camera_pre


# only for training
class GoogleScannedDataset(Dataset):
    def __init__(self, args, mode, **kwargs):
        self.folder_path = os.path.join(args.dataset_dir, "TrainingSet/google_scanned_objects/")
        ...
        self.scene_path_list = [os.path.join(self.folder_path, scene_name) for scene_name in scene_names]
    ...
    def __getitem__(self, idx):
        ...
        #     render_pose,
        #     train_poses,
        #     num_select * subsample_factor,
        #     tar_id=id_render,
        #     angular_dist_method="vector",
        # )
        # id_feat = np.random.choice(id_feat_pool, num_select, replace=False)
