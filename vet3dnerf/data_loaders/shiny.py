...
from .data_utils import random_crop, get_nearest_pose_ids, parse_camera_pre
...
class ShinyDataset(Dataset):
    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        ...
        self.folder_path = os.path.join(args.dataset_dir, "TestSet/shiny/")
        self.args = args
        ...
        for i, scene in enumerate(scenes):
            ...
            _, poses, bds, render_poses, intrinsic, i_test = load_llff_data(
                scene_path, load_imgs=False, factor=factor, render_style="", split_train_val=0
            )
            if len(intrinsic) == 3:
                H, W, f = intrinsic
                cx = W / 2.0
            ...
            image_dir = os.path.join(scene_path, f"images_{factor}")
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "scene_id": train_set_id,
            "src_pose_ids": nearest_pose_ids,
            "src_poses": src_poses,
